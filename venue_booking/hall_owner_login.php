                ...
                <div id="container_demo" >
                    <div id="wrapper">
                        <div id="login" class="animate form">
                            ...
                            <form action="hall_owner_login.php" method="post" > 
                                <h1>Log in</h1> 
                                <p> 
                                ...
                                <p class="change_link">
									Not a member yet ?
									<a href="hall_owner_signup.php">Join us</a>
								</p>
                            </form>
                        </div>
...
<?php
	if(isset($_POST['login']))
	{
		...
		if($rowcount==0)
		{
            ...
            echo "<a href='hall_owner_signup.php'>Click to join </a></center>";
		}
		else if($email = $user_query_res['email'] and $password == $user_query_res['password'])
		{
			...
			$moderator_query = $conn->query("select * from hall_owner where email = '$email'");
			$modcount=mysqli_num_rows($moderator_query);
			if($modcount>0)
			{
				header('location: hall_owner_portal.php');
			}
			//else
			//{
