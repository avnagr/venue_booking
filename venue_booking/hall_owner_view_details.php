...
$hall_d=$conn->query("select hall_id from hall_owner where owner_id='$owner_id' ");
$res= $hall_d->fetch_array(MYSQLI_BOTH);
$hall_id=$res['hall_id'];
...
if($status==2)
	echo "<center><h3>Your request has been canceled due to fake information</h3></center>";
?>
	</body>
	</html>